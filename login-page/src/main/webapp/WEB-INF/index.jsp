...
<!-- Mirrored from mannatthemes.com/AMPS/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Apr 2025 12:20:54 GMT -->
<head>
    

    <meta charset="utf-8" />
            <title>AMPS | AMPS - Admin & Dashboard Template</title>
            ...
            <!-- App favicon -->
            <link rel="shortcut icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTw3YAtKhDsT9M192HvbcnH-qDTrRawqtwsu9NFUDZRMkUDFMFVDMrarwRLNEalWQ2HzeI&usqp=CAU">
                    ...
                    <li class="dropdown topbar-item">
                        ...
                        <div class="dropdown-menu stop dropdown-menu-end dropdown-lg py-0">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom nav-success nav-justified mb-1" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link mx-0" data-bs-toggle="tab" href="#TeAMPS" role="tab" aria-selected="false" tabindex="-1">
                                        Team
                                    </a>
                                </li>
                            </ul>
                            <div class="ms-0" style="max-height:230px;" data-simplebar>
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="TeAMPS" role="tabpanel" aria-labelledby="teAMPS-tab" tabindex="0">
                                        <!-- item-->
                                        <a href="#" class="dropdown-item py-3">
                                            <small class="float-end text-muted ps-2">1 hr ago</small>
                                            <div class="d-flex align-items-center">
    ...
    <div class="startbar d-print-none">
        ...
        <div class="brand">
            <a href="index.html" class="logo">
                <span>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTw3YAtKhDsT9M192HvbcnH-qDTrRawqtwsu9NFUDZRMkUDFMFVDMrarwRLNEalWQ2HzeI&usqp=CAU" alt="logo-small" class="logo-md" width="150" height="auto">
            ...
            <div class="startbar-collapse" id="startbarCollapse" data-simplebar>
                <div class="d-flex align-items-start flex-column w-100">
                    ...
                    <ul class="navbar-nav mb-auto w-100">
                        ...
                        <li class="nav-item">
                            <a class="" href="#sidebarDashboards" data-bs-toggle="collapse" role="button"
                                aria-expanded="false" aria-controls="sidebarDashboards">
                              <i class="iconoir-home-simple menu-icon" style="color: green;"></i>
...
<!-- Mirrored from mannatthemes.com/AMPS/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Apr 2025 12:21:32 GMT -->
</html>